...
public class GrayGreffedCommandSystemBlock extends GreffedCommandSystemBlock{
    public GrayGreffedCommandSystemBlock(Settings settings) {
        super(settings);
        }
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        if(Screen.hasShiftDown()){
            tooltip.add(Text.translatable("tooltip.thelongstory.gray_greffed_command_system"));
        }else{
