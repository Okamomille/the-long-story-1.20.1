...
import net.okamiz.thelongstory.entity.ai.CrawlerAttackGoal;
...
public class CrawlerEntity extends ZombieEntity {
    ...
    public CrawlerEntity(EntityType<? extends ZombieEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new CrawlerAttackGoal(this, 1D, true));
    ...
    public static DefaultAttributeContainer.Builder createCrawlerAttributes(){
        return HostileEntity.createHostileAttributes()
                ...
                .add(EntityAttributes.GENERIC_ARMOR, 2.1f)
