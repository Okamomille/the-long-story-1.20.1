...
public class TickelerEntity extends ZombieEntity {
    ...
    private static final TrackedData<Boolean> ATTACKING =
            DataTracker.registerData(TickelerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public TickelerEntity(EntityType<? extends ZombieEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TickelerAttackGoal(this, 1D, true));
    ...
    public static DefaultAttributeContainer.Builder createTickelerAttributes(){
